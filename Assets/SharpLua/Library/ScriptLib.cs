...
namespace SharpLua.Library
{
    public class ScriptLib
    {
        ...
        public static void RegisterFunctions(LuaTable module)
        {
            ...
            module.Register("importClass", ImportClass);
        ...
        public static LuaValue ImportClass(LuaValue[] args)
        {
            string className = args[0].ToString();
            AssemblyCache.ImportNamespace(className);
            Type t = AssemblyCache.FindType(className);
            if (t == null)
                throw new Exception("Cannot find type '" + className + "'!");

            LuaValue mt = ObjectToLua.StaticClassToLuaTable(t);
