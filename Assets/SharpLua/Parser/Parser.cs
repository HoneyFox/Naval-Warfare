...
namespace SharpLua.Parser
{
    public partial class Parser
    {
        ...
        private Function ParseFunction(out bool success)
        {
            ...
            MatchTerminalStringWithNextCharCheck("function", out success);
            if (!success)
            {
                position = start_position;
        ...
        private LocalVar ParseLocalVar(out bool success)
        {
            ...
            MatchTerminalStringWithNextCharCheck("local", out success);
            if (!success)
            {
                position = start_position;
        ...
        private ReturnStmt ParseReturnStmt(out bool success)
        {
            ...
            MatchTerminalStringWithNextCharCheck("return", out success);
            if (!success)
            {
                position = start_position;
        ...
        private BreakStmt ParseBreakStmt(out bool success)
        {
            ...
            MatchTerminalStringWithNextCharCheck("break", out success);
            if (!success)
            {
                position = start_position;
        ...
        private DoStmt ParseDoStmt(out bool success)
        {
            ...
            MatchTerminalStringWithNextCharCheck("do", out success);
            if (!success)
            {
                position = start_position;
            ...
            MatchTerminalStringWithNextCharCheck("end", out success);
            if (!success)
            {
        ...
        private IfStmt ParseIfStmt(out bool success)
        {
            ...
            MatchTerminalStringWithNextCharCheck("if", out success);
            if (!success)
            {
                position = start_position;
            ...
            MatchTerminalStringWithNextCharCheck("then", out success);
            if (!success)
            {
            ...
            {
                int seq_start_position1 = position;
                MatchTerminalStringWithNextCharCheck("else", out success);
                if (!success) { break; }
        ...
        private ElseifBlock ParseElseifBlock(out bool success)
        {
            ...
            MatchTerminalStringWithNextCharCheck("elseif", out success);
            if (!success)
            {
                position = start_position;
        ...
        private ForStmt ParseForStmt(out bool success)
        {
            ...
            MatchTerminalStringWithNextCharCheck("for", out success);
            if (!success)
            {
                position = start_position;
        ...
        private ForInStmt ParseForInStmt(out bool success)
        {
            ...
            MatchTerminalStringWithNextCharCheck("in", out success);
            if (!success)
            {
        ...
        private WhileStmt ParseWhileStmt(out bool success)
        {
            ...
            MatchTerminalStringWithNextCharCheck("while", out success);
            if (!success)
            {
                position = start_position;
        ...
        private RepeatStmt ParseRepeatStmt(out bool success)
        {
            ...
            MatchTerminalStringWithNextCharCheck("repeat", out success);
            if (!success)
            {
                position = start_position;
            ...
            MatchTerminalStringWithNextCharCheck("until", out success);
            if (!success)
            {
        ...
        private NilLiteral ParseNilLiteral(out bool success)
        {
            ...
            MatchTerminalStringWithNextCharCheck("nil", out success);
            if (success) { ClearError(errorCount); }
        ...
        private BoolLiteral ParseBoolLiteral(out bool success)
        {
            ...
            while (true)
            {
                boolLiteral.Text = MatchTerminalStringWithNextCharCheck("true", out success);
                if (success) { ClearError(errorCount); break; }

                boolLiteral.Text = MatchTerminalStringWithNextCharCheck("false", out success);
                if (success) { ClearError(errorCount); break; }
        ...
        {
            int errorCount = Errors.Count;
            MatchTerminalStringWithNextCharCheck("and", out success);
            ...
            MatchTerminalStringWithNextCharCheck("false", out success);
            if (success) { ClearError(errorCount); return; }
            ...
            MatchTerminalStringWithNextCharCheck("not", out success);
            if (success) { ClearError(errorCount); return; }

            MatchTerminalStringWithNextCharCheck("or", out success);
            if (success) { ClearError(errorCount); return; }
            ...
            MatchTerminalStringWithNextCharCheck("true", out success);
            if (success) { ClearError(errorCount); return; }
        ...
        private string ParseUnaryOperator(out bool success)
        {
            ...
            string str = MatchTerminalStringWithNextCharCheck("not", out success);
            if (success)
            {
                ClearError(errorCount);
                text.Append(str);
        ...
        private string ParseBinaryOperator(out bool success)
        {
            ...
            str = MatchTerminalStringWithNextCharCheck("and", out success);
            if (success)
            {
                ClearError(errorCount);
                text.Append(str);
            ...
            str = MatchTerminalStringWithNextCharCheck("or", out success);
            if (success)
            {
                ClearError(errorCount);
                text.Append(str);
